...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default='data/dotav1_poly.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default='runs/train/yolov5m_csl_dotav1/weights/best.pt', help='model.pt path(s)')
